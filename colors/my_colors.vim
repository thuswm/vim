...
" General colors
hi Normal		ctermfg=121		ctermbg=232		cterm=none		guifg=#e3e0d7	guibg=#242424	gui=none
...
hi Constant		ctermfg=174		cterm=none		guifg=#ffcccc	gui=none
hi Number		ctermfg=174		cterm=none		guifg=#ffcccc	gui=none
hi PreProc		ctermfg=174		cterm=none		guifg=#ffcccc	gui=none
...
hi Comment		ctermfg=170		cterm=none		guifg=#9c998e	gui=italic
